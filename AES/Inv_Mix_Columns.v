...
function [7:0] mul_09(input [7:0] x);
begin
    mul_09 = mul_2(mul_2(mul_2(x))) ^ x;
end
endfunction

//  mul_0B function that uses the mul2 function
function [7:0] mul_0B(input [7:0] x);
begin
    mul_0B =   mul_2(mul_2(mul_2(x) ^ x)   ) ^ x;
end
endfunction

//  mul_0D function that uses the mul2 function
function [7:0] mul_0D(input [7:0] x);
begin
    mul_0D =   mul_2(mul_2( mul_2(x) ^ x) ) ^ x;
end
endfunction

//  mul_0E function that uses the mul2 function
function [7:0] mul_0E(input [7:0] x);
begin
    mul_0E =   mul_2( mul_2(mul_2(x) ^ x) ^ x);
end
endfunction
